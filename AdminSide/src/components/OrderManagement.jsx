                  ...
                  {expandedCard === order.id && (
                    <div className="flex justify-around mt-4">
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-[#135918] text-white font-bold hover:bg-green-700"
                      >
                        Confirm
                      </button>
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-red-900 text-white font-bold hover:bg-red-800"
                      >
                        Decline
                      </button>
                    </div>
